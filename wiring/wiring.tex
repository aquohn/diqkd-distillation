...
\item[]}{\end{list}}
  ...
  \begin{align}
    ...
    \end{figure}
      ...
      Since wirings are linear operations, can we study the effect on a general wiring from the effect on the PR box?
      ...
      FIXME wiring can only make the CHSH worse, so the fixing strategy won't work...
      ...
      \subsection{Wirings as Linear Transformations}
