...
\item[]}{\end{list}}
  ...
  decorations.pathreplacing, intersections, math, calc, 3d, backgrounds}
                  ...
                  \begin{center}
                    \begin{tikzpicture}[x=1pt,y=1pt]
                      \tikzmath{\w1 = 3em; \h1 = 1.5em;
                        \w2 = 5em; \h2 = 1.5em; \inflh = 0.2*\h2; \signalh = 0.5*\h1;
                      ...
                      \draw[mid arrow, classinfl] (M1.south west) ++(\olap1, 0) coordinate (M1 in)
                        (M1 in |- {{(0, -2*\h1)}}) -- ++(0, \signalh) node[right] {\(x_0\)} -- ++(0, \signalh) coordinate (temp1);
                      \draw[classinfl] (temp1) -- (M1 in);
                      \draw[mid arrow, classinfl] (M1 in |- M1.north) -- ++(0, \signalh) node[right] {\(a_0\)} -- ++(0, \signalh);

                      \draw[mid arrow, classinfl] (N1.south east) ++(-\olap1, 0) coordinate (N1 in)
                        (N1 in |- {{(0, -2*\h1)}}) -- ++(0, \signalh) node[left] {\(y_0\)} -- ++(0, \signalh) coordinate (temp1);
                      \draw[classinfl] (temp1) -- (N1 in);
                      \draw[mid arrow, classinfl] (N1 in |- N1.north) -- ++(0, \signalh) node[left] {\(b_0\)} -- ++(0, \signalh);
                    \end{tikzpicture}
                  \end{center}
                \end{minipage}
                \begin{minipage}{0.6\linewidth}
                  ...
                  \begin{tikzpicture}[x=1pt,y=1pt]
                    ...
                    \node[classbox,
                      minimum width = \w{2},
                      minimum height = \h{2},
                      ] (chiA 1) at (-\w2-\hgap2, \vgap2 + 0.5*\h2 + 2*\inflh) {\(\chi_A^{(1)}\)};
                    ...
                    \node[classbox,
                      minimum width = \w{2},
                      minimum height = \h{2},
                      ] (chiB 1) at (\w2+\hgap2, \vgap2 + 0.5*\h2 + 2*\inflh) {\(\chi_B^{(1)}\)};
                    \draw[classinfl, mid arrow] (SR.north) ++(\olap2, 0) -- ++(0, \inflh) coordinate (temp1) (chiB 1.south west) ++(\olap2, 0) -- ++(0, -\inflh) coordinate (temp2)
                      (temp1) -- (temp2);

                    % The first state
                    \coordinate (temp1) at ($ (chiA 1.north) + (0, \vgap2) + (0, 0.5*\h1) $);
                    \node[nclassbox,
                      minimum width = \w{1},
                      minimum height = \h{1},
                      ] (state1) at (temp1 -| {{(0,0)}}) {\(\rho\)};
                    ...
                    % Alice's classical data
                    \draw[mid arrow, classinfl] (M1.south west) ++(\olap1, 0) coordinate (M1 in)
                      (M1 in |- {{(0, -2*\h1)}}) -- ++(0, \signalh) node[right] {\(x\)} -- ++(0, \signalh) coordinate (temp1);
                    \draw[classinfl] (temp1) -- (temp1 |- chiA 1.south);
                    \draw[mid arrow, classinfl]  (temp1 |- chiA 1.north) -- ++(0, \signalh) node[right] {\(x_0\)} -- ++(0, \signalh) coordinate (temp1);
                    \draw[classinfl] (temp1) -- (M1 in);
                    \draw[mid arrow, classinfl] (M1 in |- M1.north) -- ++(0, \signalh) node[right] {\(a_0\)} -- ++(0, \signalh) coordinate (M1 out);

                    % Bob's classical data
                    \draw[mid arrow, classinfl] (N1.south east) ++(-\olap1, 0) coordinate (N1 in)
                      (N1 in |- {{(0, -2*\h1)}}) -- ++(0, \signalh) node[left] {\(y\)} -- ++(0, \signalh) coordinate (temp1);
                    \draw[classinfl] (temp1) -- (temp1 |- chiB 1.south);
                    \draw[mid arrow, classinfl]  (temp1 |- chiB 1.north) -- ++(0, \signalh) node[left] {\(y_0\)} -- ++(0, \signalh) coordinate (temp1);
                    \draw[classinfl] (temp1) -- (N1 in);
                    \draw[mid arrow, classinfl] (N1 in |- N1.north) -- ++(0, \signalh) node[left] {\(b_0\)} -- ++(0, \signalh) coordinate (N1 out);

                    % Alice's second wiring map
                    \coordinate (temp1) at ($ (chiA 1.south west) + (-\olap2, -\inflh) $);
                    \draw[mid arrow, classinfl] (SR.north west) ++(\olap2, 0) -- ++(0, \inflh) -- (temp1) coordinate (temp2);
                    \draw[classinfl] (temp2) -- (temp2 |- M1 out) coordinate (temp1);
                    \draw let \p{out} = ($ (temp1) - (M1 out) $),
                      \n{dist} = {abs(\x{out}) + 2*\olap{2}}
                      in
                      (temp1) ++(-\olap2, 0) node[classbox, anchor=south west,
                      minimum width = \n{dist},
                      minimum height = \h{2}] (chiA 2) {\(\chi_A^{(2)}\)};
                    \draw[mid arrow, classinfl] (chiA 1.north west) ++(\olap2, 0) coordinate (temp2) -- (temp2 |- chiA 2.south);
                    \draw[mid arrow, classinfl] (M1 in |- chiA 2.north) -- ++(0, \signalh) node[right] {\(a\)} -- ++(0, \signalh);

                    % Bob's second wiring map
                    \coordinate (temp1) at ($ (chiB 1.south east) + (\olap2, -\inflh) $);
                    \draw[mid arrow, classinfl] (SR.north east) ++(-\olap2, 0) -- ++(0, \inflh) -- (temp1) coordinate (temp2);
                    \draw[classinfl] (temp2) -- (temp2 |- N1 out) coordinate (temp1);
                    \draw let \p{out} = ($ (temp1) - (N1 out) $),
                      \n{dist} = {abs(\x{out}) + 2*\olap{2}}
                      in
                      (temp1) ++(\olap2, 0) node[classbox, anchor=south east,
                      minimum width = \n{dist},
                      minimum height = \h{2}] (chiB 2) {\(\chi_B^{(2)}\)};
                    \draw[mid arrow, classinfl] (chiB 1.north east) ++(-\olap2, 0) coordinate (temp2) -- (temp2 |- chiB 2.south);
                    \draw[mid arrow, classinfl] (N1 in |- chiB 2.north) -- ++(0, \signalh) node[left] {\(b\)} -- ++(0, \signalh);
                  \end{tikzpicture}
                  \end{center}
                \end{minipage}
                  \caption[Depiction of a generic LOSR operation.]{\label{fig:losr} A generic LOSR operation transforms an initial behaviour \(p(a_0 b_0|x_0 y_0)\), depicted on the left, into a new overall behaviour \(p'(ab|xy)\), using classical preprocessing and postprocessing, and shared randomness. The LOSR transformation is depicted in blue. (Adapted from~\cite{BellResourceTheory})}
                \end{figure}
              ...
              \begin{center}
                \begin{tikzpicture}[x=1pt,y=1pt]
                  ...
                  \draw[mid arrow, classinfl] (M1.south west) ++(\olap1, 0) coordinate (M1 in)
                    (M1 in |- {{(0, -2*\h1)}}) -- ++(0, \signalh) node[right] {\(x\)} -- ++(0, \signalh) coordinate (temp1);
                  \draw[classinfl] (temp1) -- (temp1 |- chiA 1.south);
                  \draw[mid arrow, classinfl]  (temp1 |- chiA 1.north) -- ++(0, \signalh) node[right] {\(x_1\)} -- ++(0, \signalh) coordinate (temp1);
                  \draw[classinfl] (temp1) -- (M1 in);
                  \draw[mid arrow, classinfl] (M1 in |- M1.north) -- ++(0, \signalh) node[right] {\(a_1\)} -- ++(0, \signalh) coordinate (M1 out);
                  ...
                  \draw[classinfl] (temp1) -- (N1 in);
                  \draw[mid arrow, classinfl] (N1 in |- N1.north) -- ++(0, \signalh) node[left] {\(b_1\)} -- ++(0, \signalh) coordinate (N1 out);

                  % Alice's second wiring map
                  \coordinate (chiA 2 SR) at ($ (chiA 1.south west) + (-\olap2-\hgap2, -\inflh) $);
                  \draw[mid arrow, classinfl] (SR.north west) ++(\olap2, 0) -- ++(0, \inflh) -- (chiA 2 SR) coordinate (temp2);
                  \draw[classinfl] (temp2) -- (temp2 |- M1 out) coordinate (temp1);
                  \draw let \p{out} = ($ (temp1) - (M1 out) $),
                    \n{dist} = {abs(\x{out}) + 2*\olap{2}}
                    in
                    ...
                    minimum width = \n{dist},
                    minimum height = \h{2}] (chiA 2) {\(\chi_A^{(2)}\)};
                  \draw[mid arrow, classinfl] (chiA 1.north west) ++(\olap2+\hgap2, 0) coordinate (temp2) -- (temp2 |- chiA 2.south);
                  \draw[mid arrow, classinfl] (M1 in |- chiA 2.north) -- ++(0, \signalh) node[right] {\(x_2\)} -- ++(0, \signalh) coordinate (x2);

                  % Bob's second wiring map
                  \coordinate (chiB 2 SR) at ($ (chiB 1.south east) + (\olap2, -\inflh) $);
                  \draw[mid arrow, classinfl] (SR.north east) ++(-\olap2, 0) -- ++(0, \inflh) -- (chiB 2 SR) coordinate (temp2);
                  \draw[classinfl] (temp2) -- (temp2 |- N1 out) coordinate (temp1);
                  \draw let \p{out} = ($ (temp1) - (N1 out) $),
                    \n{dist} = {abs(\x{out}) + 2*\olap{2}}
                    in
                  ...
                  \draw[classinfl] (M2.south west) ++(\olap1, 0) coordinate (M2 in)
                    (x2) -- (M2 in);
                  \draw[mid arrow, classinfl]  (x2 |- M2.north) -- ++(0, \signalh) node[right] {\(a_2\)} -- ++(0, \signalh) coordinate (a2);

                  % Bob's classical data
                  \draw[classinfl] (N2.south east) ++(-\olap1, 0) coordinate (N2 in)
                    (y2) -- (N2 in);
                  \draw[mid arrow, classinfl]  (y2 |- N2.north) -- ++(0, \signalh) node[left] {\(b_2\)} -- ++(0, \signalh) coordinate (b2);

                  % Alice's third wiring map
                  \coordinate (chiA 3 SR) at ($ (chiA 2 SR) + (-\olap2-\hgap2, 0) $);
                  \draw[mid arrow, classinfl] (SR.west) -- (chiA 3 SR) coordinate (temp2);
                  \draw[classinfl] (temp2) -- (temp2 |- a2) coordinate (temp1);
                  \draw let \p{out} = ($ (temp1) - (a2) $),
                    \n{dist} = {abs(\x{out}) + 2*\olap{2}}
                    in
                    (temp1) ++(-\olap2, 0) node[classbox, anchor=south west,
                    minimum width = \n{dist},
