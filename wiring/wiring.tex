...
\item[]}{\end{list}}
  ...
  \begin{align}
    \Tr\left[\left(\sum_i p_i \proj{i}\right) (Z + Z^{\dagger})\right] &= 
    \Tr\left[ \sum_i p_i \sum_{i'} z_{i;i'} \ket{i}\bra{i'} + {z_{i';i}}^* \ket{i}\bra{i'} \right] \\
                                                            &= 
    \sum_i p_i z_{i;i} \ket{i}\bra{i} + {z_{i;i}}^* \ket{i}\bra{i} \\
    \Tr\left[\left(\sum_i p_i \proj{i}\right) (Z^{\dagger}Z)\right] &=
    \Tr\left[ \sum_i p_i \sum_{i'} z_{i;i'} {z_{i';i}}^* \ket{i}\bra{i'} \right] \\
                                                            &\geq 
    \sum_i p_i \abs{z_{i;i}}^2 \ket{i}\bra{i} \\
    \Tr\left[\left(\sum_i p_i \proj{i}\right) (ZZ^{\dagger})\right] &= 
    \Tr\left[ \sum_i p_i \sum_{i'} {z_{i;i'}}^* z_{i';i} \ket{i}\bra{i'} \right] \\
                                                            &\geq 
    \sum_i p_i \abs{z_{i;i}}^2 \ket{i}\bra{i}
  \end{align}
  where the upper bounds hold because \(\abs{z_{i;i}}^2 \geq 0\), and since they do not occur in the expansion of trace with \(Z + Z^{\dagger}\), are minimised by being set to 0. Further, since \(z_{i;i}\) only occurs as \(\abs{z_{i;i}}^2\) or \(z_{i;i} + {z_{i;i}}^*\), it can be generically assumed to be real, and \(Z\) can therefore be assumed to be Hermitian.

  \begin{align}
    \Tr[\rho_{\crv{V}_1\crv{V}_2\crv{J}} (Z + Z^{\dagger})] &= \\
    \Tr[\rho_{\crv{V}_1\crv{V}_2\crv{J}} (Z^{\dagger}Z)] &= \\
    \Tr[\rho'_{\crv{V}_1\crv{V}_2\crv{J}} (ZZ^{\dagger})] &= \\
    \Tr[\rho_{\crv{V}_1\crv{V}_2\crv{JE}} (Z + Z^{\dagger})] &= \Tr\left[ \begin{gathered} \sum_{v_1 v_2 j e} \Tr\left[\rho_{ABE} \left(M_{v_1} \otimes N_{v_2} \otimes O_e\right)\right] P_{\crv{J|V_1V_2E}}(j|v_1v_2e) \\ \sum_{i'} z_{i;i'} \ket{i}\bra{i'} + {z_{i';i}}^* \ket{i}\bra{i'} \end{gathered} \right] \\
                                                             &= \begin{gathered} \sum_{v_1 v_2 j e} \Tr\left[ \rho_{ABE} \left(M_{v_1} \otimes N_{v_2} \otimes O_e\right)\right] P_{\crv{J|V_1V_2E}}(j|v_1v_2e) \left( z_{i;i} + {z_{i;i}}^* \right) \end{gathered} \\
    \Tr[\rho_{\crv{V}_1\crv{V}_2\crv{JE}} (Z^{\dagger}Z)] &= \Tr\left[ \begin{gathered} \sum_{v_1 v_2 j e} \Tr\left[\rho_{ABE} \left(M_{v_1} \otimes N_{v_2} \otimes O_e\right)\right] P_{\crv{J|V_1V_2E}}(j|v_1v_2e) \\ \sum_{i'} z_{i;i'}{z_{i;i'}}^*  \ket{i}\bra{i'} \end{gathered} \right] \\
                                                             &\geq \Tr\left[ \begin{gathered} \sum_{v_1 v_2 j e} \Tr\left[\rho_{ABE} \left(M_{v_1} \otimes N_{v_2} \otimes O_e\right)\right] P_{\crv{J|V_1V_2E}}(j|v_1v_2e) \\ \abs{z_{i;i}}^2  \ket{i}\bra{i} \end{gathered} \right] \\
                                                             &= \begin{gathered} \sum_{v_1 v_2 j e} \Tr\left[\rho_{ABE} \left(M_{v_1} \otimes N_{v_2} \otimes O_e\right)\right] P_{\crv{J|V_1V_2E}}(j|v_1v_2e) \abs{z_{i;i}}^2  \end{gathered} \\
    \Tr[\rho''_{\crv{V}_1\crv{V}_2\crv{JE}} (ZZ^{\dagger})] &= \sum_{v_1 v_2 v_1' v_2' j e} \Tr\left[\rho_{ABE} \left(M_{v_1} \otimes N_{v_2} \otimes O_e\right)\right] P_{\crv{J|V_1V_2E}}(j|v_1'v_2'e) P_{\crv{V_1V_2}}(v_1'v_2')\proj{v_1v_2je} \\
  \end{align}
