...
Any[]
          ...
          & \nu_{\crv{A}} \E_{\crv{A}}[{(\E_{\crv{B}|\crv{A}}[f(\crv{A},\crv{B})])}^2] \\ + & \nu_{\crv{B}} \E_{\crv{B}}[{(\E_{\crv{A}|\crv{B}}[f(\crv{A},\crv{B})])}^2] \\
                        ...
                        \end{equation}
                        where we have used \(\sqrt{M_a}^{\dagger} = \sqrt{M_a}\), the columns of \(V\) are a set of \(d\) orthonormal vectors in \(\Hs\). Therefore, the operators \(M_a\) induce a unique set of \(d\) orthonormal vectors in \(\Hs\).
                        ...
                        \end{equation}
                        and therefore any orthonormal set of vectors generates a unique POVM in this way, and it is clear that this construction inverts the previous mapping from POVMs to sets of vectors. This is in agreement with~\cite{RandPOVM}, where a distribution over the isometries \(V\) (that is, the sets of \(d\) orthonormal vectors) is shown to recover the uniform distribution on the Lebesgue measure over the set of POVMs.
