...
\begin{frame}{Local Operations and Shared Randomness\setcounter{footnote}{0}\footfullcite{NonclassicalCausation}}
  \begin{onlyenv}<1-3>
    \begin{itemize}[<+->]
...
\begin{frame}{Discussion}
  \begin{itemize}[<+->]
    ...
    \item Connection to complete positivity of LOSR transformations?\only<.->{\footfullcite{LocalTransformations}}
